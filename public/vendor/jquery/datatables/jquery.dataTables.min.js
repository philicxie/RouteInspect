...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"后一页",sPrevious:"前一页"},sEmptyTable:"此表为空",sInfo:"显示 _START_ 到 _END_ 项, 共 _TOTAL_ 项",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(筛选自 _MAX_ 项)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"显示 _MENU_ 项",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"搜索 :&nbsp&nbsp&nbsp&nbsp",sUrl:"",sZeroRecords:"没有结果"},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};S(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,bSortable:!0,bVisible:!0,fnCreatedCell:null,
